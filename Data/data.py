...
FC_Category_Description = 'PROD-0002_Category_description'
FC_Invalid_Category = 'PROD-0002_Category_Invalid'
FC_Category_Update = 'PROD-0002_Update_Category'
FC_Category_Description_Update = 'PROD-0002_Category_description_Update'

# Finance Customize Budget
FCB_budget= 'PROD-0003_Create_Custom_Budget'
FCB_budget_description = 'PROD-0003_Custom_Budget_description'
FCB_budget_update = 'PROD-0003_Update_Custom_Budget'
FCB_budget_description_update = 'PROD-0003_Custom_Budget_description_Update'

# Product Squad Role 
PSR_Product_Squad_Role = 'PROD-0004_Create_Produt_Squad_Role '
PSR_Produt_Squad_Role_Description ='PROD-0004_Produt_Squad_Role_description'
PSR_Product_Squad_Role_Invalid = 'PROD-0004_Product_Squad_Invalid'
PSR_Produt_Squad_Role_Update = 'PROD-0004_Update_Product_Squad_Role'
...
TXT_baseline = '1234'
TXT_uom = 'cm'
PPOS_KEY_RESULT_UPDATE = 'PROD-0005_OKR_keyname'
PPOS_keyDescription_UPDATE = 'PROD-0005_OKR_keyname_Description'
PPOS_BASELINE = '12345'
PPOS_UOM = 'kg'
PPOS_product = 'PROD-0005_OKR_Squad_product'
PPOS_PP_product = 'PROD-0005_OKR_Squad_PP_product'
PPOS_PP_description = 'PROD-0005_OKR_Squad_PP_product_description'
PPOS_SQUAD = 'PROD-0005_OKR_PP_product_SQUAD'
