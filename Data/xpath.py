...
Custom_create_name = '//input[@name="customFieldName"]'
Custom_Addto = '//input[@id="search-field"]'
Custom_Addto_dropdown = '//li[@id="label-{name}"]'
Custom_finance = '//li[@id="label-Finance"]'
Custom_text = '//p[@id="popup-header-Create New Custom Field for Portfolios"]'
Custom_placeholder = '//input[@id="portfolio-management-custom-field-placeholder"]'
Custom_Tooltip = '//input[@name="customFieldToolTip"]'
Custom_add_type = '//div[@id="portfolio-management-custom-field-type"]'
Custom_add_type_text = '//li[@id="Text"]'
Custom_mandatory = '//input[@id="portfolio-management-custom-field-active"]'
Custom_visibility = '//input[@id="portfolio-management-custom-field-visibility-show"]'
Custom_strageticoutcome_tab = '//a[@id="Strategic Outcome-tabs"]'
Custom_AddStragicoutcome = '//button[@id="create-strategic-outcome-nullstate-btn"]'
...
Custom_OKR_PROD_17 = '//input[@id="custom-fields-PROD_17_Teamleader"]'
Custom_PPG_tab = '//a[@id="PPG-tabs"]'
Custom_ADD_PPG= '//p[text()="Add PPG"]'
Custom_PPG_Field='//td[text()="PROD_17_PPPPGG"]'
