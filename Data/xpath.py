...
BTN_PPG_TAB = '//a[@id="PPG-tabs"]'
BTN_ADD_PPG ='//p[text()="Add PPG"]/parent::button'
INPUT_ppg_name = '//input[@id="ppg-name"]'
BTN_PPg_OWNER = '//div[@id="ppg-owner"]'
INPUT_PPG_OWNER = '//li[@id="Lohitha"]'
BTN_ppg_type = '//div[@id="ppg-type"]'
INPUT_type_product ='//li[@id="Product"]'
INPUT_type_PlatForm = '//li[@id="Platform"]'
BTN_PPG_SAVE ='//button[@id="ppg-create-save-btn"]'
BTN_product_platform = '//a[@id="Products/Platforms-tabs"]'
BTN_ADD_product_platform ='//button[@id="add-product-platform"]'
BTN_create_prod_platform = '//button[@id="product-platform-create-btn"]'
INPT_prod_plat_name = '//input[@id="product-platform-name"]'
BTN_PROD_PLAT_OWNER = '//div[@id="product-platform-owner"]'
BTN_TYPE_PROD_PLAT = '//div[@id="product-platform-type"]'
BTN_prod_plat_save = '//button[@id="product-platform-create-save"]'
...
INPUT_strat_out_name = '//li[@id="PROD_6_so"]'
BTN_OKR_save = '//button[@id="okr-create-save"]'
BTN_OKR_cancel = '//button[@id="okr-create-cancel"]'
BTN_okr_search = '//input[@id="okr-search-input"]'
BTN_add_result = '//button[@id="okr-add-result-{name}"]'
BTN_key_result_name = '//input[@id="keyresult-key-result"]'
BTN_Key_result_description ='//textarea[@id="keyresult-description"]'
...
Input_Type_Platform = '//li[@id="Platform"]'
Input_Type_Product = '//li[@id="Product"]'
BTN_PPG_Cancel = '//button[@id="ppg-create-cancel-btn"]'
BTN_PPG_Save = '//button[@id="ppg-create-save-btn"]'
BTN_PPG_Kebab = '//div[@id="ppg-more-btn-{name}"]'
BTN_PPG_Edit = '//li[@id="ppg-edit-{name}"]'
BTN_PPG_Edit_Cancel = '//button[@id="ppg-edit-cancel-btn"]'
BTN_PPG_Edit_Save = '//button[@id="ppg-edit-save-btn"]'
BTN_PPG_Delete = '//li[@id="ppg-delete-{name}"]'
BTN_PPG_Delete_Cancel = '//button[@id="comman-delete-cancel-btn"]'
BTN_PPG_Delete_Confirm = '//button[@id="comman-delete-confirm-btn"]'
...
BTN_Product_Platform_Cancel = '//button[@id="product-platform-create-cancel"]'
BTN_Product_Platform_Save = '//button[@id="product-platform-create-save"]'
...
BTN_Product_Platform_Edit_Cancel = '//button[@id="product-platform-edit-cancel"]'
BTN_Product_Platform_Edit_Save = '//button[@id="product-platform-edit-save"]'
...
BTN_Product_Platform_Delete_Cancel = '//button[@id="comman-delete-cancel-btn"]'
BTN_Product_Platform_Delete_Confirm = '//button[@id="comman-delete-confirm-btn"]'
