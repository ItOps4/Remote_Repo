...
BTN_Create_Custom_Fields = '//button[@id="custom-field-create-btn"]'
Custom_cancel = '//button[@id="create-custom-field-cancel"]'
Input_custom_field_name = '//input[@name="customFieldName"]'
Search_CF_Addto = '//input[@id="search-field"]'
Select_CF_Addto = '//li[@id="label-{name}"]'
Custom_finance = '//li[@id="label-Finance"]'
# Custom_text = '//p[@id="popup-header-Create New Custom Field for Portfolios"]'
Input_CF_placeholder = '//input[@id="portfolio-management-custom-field-placeholder"]'
Input_CF_Tooltip = '//input[@name="customFieldToolTip"]'
Dropdown_CF_add_type = '//div[@id="portfolio-management-custom-field-type"]'
Select_CF_add_type_text = '//li[@id="{name}"]'
Custom_select_radio = '//li[@id="Radio Box"]'
Custom_text_area = '//li[@id="Text Area"]'
CF_check_box = '//li[@id="Check Box"]'
Custom_number = '//li[@id="Number"]'
Custom_Select = '//li[@id="Select"]'
CF_mand_yes = '//p[text()="Yes"]/parent::label'
CF_mand_no = '//p[text()="No"]/parent::label'
CF_visi_show = '//p[text()="Show"]/parent::label'
CF_visi_hide = '//p[text()="Hide"]/parent::label'
CF_strageticoutcome_tab = '//a[@id="Strategic Outcome-tabs"]'
BTN_CF_AddStragicoutcome = '//button[@id="create-strategic-outcome-nullstate-btn"]'
Custom_strageticoutcome_add = '//input[@id="custom-fields-PROD_17_Teamleader"]'
Custom_strageticoutcome_PROD17 = '//td[@id="custom-id-PROD_17_Teamleader"]'
Custom_Add_OKR= '//button[@id="okr-nullstate-btn"]'
Custom_OKR_PROD_17 = '//p[@id="PROD_17_Teamleader-input-field-label"]'
Custom_PPG_tab = '//a[@id="PPG-tabs"]'
Custom_ADD_PPG= '//p[text()="Add PPG"]'
...
CF_Enter_options = '//input[@id="portfolio-management-custom-field-options"]'
